...
-------------------------------------
Maps data/review/collin_letters_person_index.csv (digitized from the
...
Output: data/review/collin_letters_person_match.csv (all Collin entries
...
COLLIN_CSV = os.path.join(ROOT, "data", "review", "collin_letters_person_index.csv")
...
OUT_CSV = os.path.join(ROOT, "data", "review", "collin_letters_person_match.csv")
