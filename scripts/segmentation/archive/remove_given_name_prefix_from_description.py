...
Usage:
  ...
  python scripts/segmentation/archive/remove_given_name_prefix_from_description.py --sample 20
  python scripts/segmentation/archive/remove_given_name_prefix_from_description.py --apply
"""
import argparse
import csv
import os
