...
Run from the repo root, AFTER suggest_description_fusion_splits.py:
  python scripts/segmentation/archive/apply_description_fusion_splits.py
"""
import csv
import os
import re
...
REVIEW_TSV = os.path.join(ROOT, "data", "review", "personregister_xi_description_fusion_review.tsv")
