...
implemented here rather than left to the consumer:
  ...
  * master2 reads the resolved form (decided 2026-09-03): "Oesterling" has
  ...
  python scripts/segmentation/archive/apply_person_emendations.py
  python scripts/segmentation/archive/apply_person_emendations.py --emit
  python scripts/segmentation/archive/apply_person_emendations.py --emit-resolved
"""
import argparse
import csv
import json
